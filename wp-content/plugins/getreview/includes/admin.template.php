...
<div class="wrap">
	...
	<?php if (!get_option(GETREVIEW_GUID_KEY)): ?>
		<div class="notice notice-success">
				<p><?php printf(__('Thank you for installing GetReview!455!! For your convenience, the application panel can be managed from here: <a href="%s">%s</a>', GETREVIEW_TEXT_DOMAIN), 'https://app.getreview.pl', 'https://app.getreview.pl'); ?></p>
